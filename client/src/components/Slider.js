  ...
  return (
    <div className="frame relative">
      ...
      <div className="btns absolute bottom-20 left-0 w-fit right-0 mx-auto z-[1] text-2xl flex gap-10">
        <button
          onClick={prevSlide}
          className="prev-btn h-14 w-20 flex justify-center items-center bg-black bg-opacity-70 text-white border border-orange-500 hover:bg-orange-500 hover:text-white duration-300 rounded-lg backdrop-blur-sm"
        >
          <span>
            <BsArrowLeft />
          </span>
        ...
        <button
          onClick={nextSlide}
          className="next-btn h-14 w-20 flex justify-center items-center bg-black bg-opacity-70 text-white border border-orange-500 hover:bg-orange-500 hover:text-white duration-300 rounded-lg backdrop-blur-sm"
        >
          <span>
            <BsArrowRight />
          </span>
